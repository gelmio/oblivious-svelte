...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, "alt", "Picture of computer with sendowl payment portal");
      ...
      add_location(h3, file, 23, 8, 1207);
      attr_dev(h4, "class", "text-xl md:text-2xl");
      add_location(h4, file, 24, 8, 1266);
      attr_dev(div, "class", "md:pl-20");
      add_location(div, file, 22, 4, 1176);
