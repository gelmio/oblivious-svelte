...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(h1, file, 19, 4, 844);
      attr_dev(h20, "class", "text-xl md:text-3xl text-center");
      add_location(h20, file, 20, 4, 968);
