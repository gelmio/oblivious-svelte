...
<section class="flex flex-col items-center max-w-4xl mb-20 md:mb-32">
	...
	<div class="text-left">
		...
		<p>I surprised myself by riding all the way to the northernmost point of Britain. Then, before I knew it, I was already down to the southermost point of Spain, <em>shitting</em> myself as I looked across <em>the strait</em> to Africa...</p>
		...
		<p>I can tell you that the Enfield was the right choice; I couldn't have done it on any other machine.</p>
