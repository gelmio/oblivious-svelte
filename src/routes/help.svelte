...
<section class="flex flex-col items-center max-w-4xl mb-20 md:mb-32">
    <h2 class="text-2xl md:text-3xl text-center">Just looking for the button to click to download the book?</h2> <span class="inline-block text-xl sm:text-2xl p-4 mt-4 rounded-lg no-underline bg-oblivious"><OpenCart text="Here it is!"></OpenCart></span>
</section>
<section class="flex flex-col items-center max-w-4xl mb-20 md:mb-32">
